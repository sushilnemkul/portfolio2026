...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            className="w-full bg-white dark:bg-slate-900 font-sans md:px-10 transition-colors duration-300"
            ref={containerRef}
        >
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm md:text-base max-w-sm">
                    I&apos;ve been working as a Software Engineer for the past few years. Here&apos;s
                    a timeline of my journey and experiences.
                </p>
            </div>
